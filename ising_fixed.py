...
@njit(cache=True)
def data1(size,betaJ,n,Lattice):
	Magnetization=[]
	Energy=[]                 
	L=Lattice
	U=energy(L)
...
@njit(cache=True)
def data2(size,betaJ,n,Lattice):               
	L=Lattice
	for k in range(n):
...
if __name__=='__main__':
	...
	#plotting
	Energy,Magnetization,Lattice_init,Lattice,History=main(size,1/Temp,n,Lattice)
