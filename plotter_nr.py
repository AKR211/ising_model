from ising_nr import data1,data2,average,linspace,array,sign,gridspec,var,mean,std
import matplotlib.pyplot as plt
from numba import njit,jit
import json

@njit
def values(size,n,p,eq,Temps,delta):
	Es=[0.0]
	Ms=[0.0]
	varEs=[0.0]
	varMs=[0.0]
	for Temp in Temps:
		data=data1(size,1/Temp,n,p,delta)
...
def plot1():
	...
	for x in var:
		delta=x
		colour=colours.pop()
		Es,Ms,varEs,varMs=values(size,n,p,eq,Temps,delta)
